        ...
        <div class="table-wrapper">
			...
			<td><%=clientModel.getRmCode()%></td>
                        ...
                        <td><%=clientModel.getRiskmanagementpartner()%> 
                            <button id="try" name="try" onclick="return Edit();">Try</button>
                            
                        </td>
                        
                        <td> 
                              <a href="#editClientModal"  data-whatever="<%=clientModel.getClientid()%>" class="edit" data-toggle="modal" ><i class="material-icons" data-toggle="tooltip" title="Edit" >&#xE254;</i></a> 
