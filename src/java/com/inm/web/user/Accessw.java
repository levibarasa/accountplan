 ...
 */
package com.inm.web.user;

/**
 *
 * @author Levi
 */
import com.inm.dao.admin.user.Access;
import com.inm.dao.admin.user.User;
import com.inm.ap.security.Encode;
...
import com.inm.web.user.LdapLogin;
...
//                      }
        ...
        if (!loggedInUser.equalsIgnoreCase("") || !loggedInUser.equalsIgnoreCase(null)) {
            ...
            for (int i = 0; i < ar.size(); i++) {
                ...
                if (!accessLevel.equalsIgnoreCase("") && conPage == null) {
                    response.sendRedirect("index.jsp");
                    System.out.println("conPage => " + conPage);
                    if (conPage == null) {
                        session.setAttribute("content_page", "index.jsp");
                    }
